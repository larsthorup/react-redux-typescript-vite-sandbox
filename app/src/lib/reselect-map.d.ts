// fixed types by adding "extends SelectorArray"
...
export function createArraySelector<S extends SelectorArray, E, T>(
...
export function createObjectSelector<S extends SelectorArray, E, T>(
...
export function createArraySelector<S extends SelectorArray, E, R2, T>(
  selector1: Selector<S, E[]>,
...
export function createObjectSelector<S extends SelectorArray, E, R2, T>(
  selector1: Selector<S, ObjectMap<E>>,
  selector2: Selector<S, R2>,
...
export function createArraySelector<S extends SelectorArray, E, R2, R3, T>(
  selector1: Selector<S, E[]>,
  selector2: Selector<S, R2>,
...
export function createObjectSelector<S extends SelectorArray, E, R2, R3, T>(
  selector1: Selector<S, ObjectMap<E>>,
  selector2: Selector<S, R2>,
  selector3: Selector<S, R3>,
...
export function createArraySelector<S extends SelectorArray, E, R2, R3, R4, T>(
  selector1: Selector<S, E[]>,
  selector2: Selector<S, R2>,
  selector3: Selector<S, R3>,
...
export function createObjectSelector<S extends SelectorArray, E, R2, R3, R4, T>(
  selector1: Selector<S, ObjectMap<E>>,
  selector2: Selector<S, R2>,
  selector3: Selector<S, R3>,
  selector4: Selector<S, R4>,
